...
export default function DateEdit({
  ...
  return (
    <div
      className={cn(
        "inline-flex w-96 flex-col items-center justify-center gap-3 overflow-hidden rounded-2xl border-[1.4px] border-[#B3D9FF] bg-white py-3",
        className
      )}
    >
      {/* 헤더 */}
      ...
      <div className="flex flex-col items-center justify-start self-stretch px-3">
        ...
        <div className="inline-flex h-12 items-start justify-center self-stretch">
          {DAYS_OF_WEEK.map((day, index) => (
            ...
            >
              <div className="justify-center text-center font-['Roboto'] text-base font-normal leading-normal tracking-wide text-black">
                {day}
              </div>
            </div>
          ))}
                    ...
                    <div className="flex h-10 w-10 items-center justify-center gap-2.5">
                      <div
                        className={cn(
                          ...
                          isSelected(day)
                            ? "text-sm font-medium leading-tight tracking-tight text-black"
      ...
      <div className="inline-flex items-start justify-between self-stretch px-3">
        <div className="flex flex-1 items-start justify-end gap-2">
          <button
            ...
            className="inline-flex h-10 flex-col items-center justify-center gap-2 overflow-hidden rounded-[100px] hover:bg-[#E8F3FF] transition-colors"
          >
            <div className="inline-flex flex-1 items-center justify-center gap-2 self-stretch px-3 py-2.5">
              <div className="justify-center text-center text-sm font-bold leading-tight tracking-tight text-[#0077FF]">
                확인
              </div>
            </div>
          </button>
