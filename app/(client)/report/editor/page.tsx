  ...
  const tableOfContents: TableOfContentsItem[] = [
    ...
    },
    {
      ...
      children: [
        {
          id: "tech-level",
          title: "활용 기술 및 알고리즘 수준 및 완성도",
          completed: true,
          score: "112/100자 · 75점",
        },
        {
          id: "service-innovation",
          title: "서비스 개념, 혁신성 및 우수성",
          completed: true,
          score: "112/100자 · 75점",
        },
      ],
            ...
            <div className="flex flex-col gap-6 flex-1 px-3 py-8">
              ...
              <div className="flex flex-col gap-3 relative">
                ...
                <div className="text-[#343330] text-base leading-6">
                  ...
                  요소로 자리잡고 있습니다. 온라인·오프라인 채널의 융합, 소비자
                  구매 패턴의 다변화, 경기 변동성 확대 등으로 인해 재고 관리,
                  공급망 최적화, 판촉 전략 수립의 복잡성이 과거보다 크게
                  증가하였습니다.
                  <br />
                  <br />
                  특히,
                  ...
                  데이터와 외부 요인(계절성, 지역별 트렌드, 거시경제 지표 등)을
                  결합하여 정교한 수요 예측 모델을 제공함으로써, 리테일 기업이
                  직면한 문제를 근본적으로 해결할 수 ���습니다.
                  <br />
                  <br />
                  이를 통해 기업은:
                  <br />
                  ...
                  한 타겟 마케팅 전략 수립
                  <br />
                  • 경쟁력 확보 – 급변하는 리테일 시장에서 차별화된 데이터 기반
                  의사결정 역량 확보
                  <br />
                  <br />
