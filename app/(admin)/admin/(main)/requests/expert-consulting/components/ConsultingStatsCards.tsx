...
import { ConsultingRequestStats } from "../types";

interface ConsultingStatsCardsProps {
  stats: ConsultingRequestStats;
}

export default function ConsultingStatsCards({ stats }: ConsultingStatsCardsProps) {
  return (
