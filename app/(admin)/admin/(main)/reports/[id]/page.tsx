...
import { Camera, Divide, RotateCcw } from "lucide-react";
...
const tableOfContents = [
  {
    section: "사업 개요",
    items: [
      { name: "추진 배경 및 필요성", score: "112/100자 · 75점", highlighted: true },
  ...
  },
  {
    section: "기술 및 서비스 개요",
    items: [
      { name: "활용 기술 및 알고리즘 수준 및 완성도", score: "112/100자 · 75점" },
        ...
        <div className="flex flex-col items-start gap-6 self-stretch">
          ...
          <div className="flex justify-between items-center self-stretch">
            <div className="flex items-center gap-2">
              <Image src="/images/back.svg" alt="Arrow Left" width={32} height={32} />
            ...
            <div className="flex flex-col items-start self-stretch">
              ...
              <div className="flex flex-col items-start self-stretch">
                {tableOfContents.map((section, sectionIndex) => (
                  <div key={sectionIndex} className="flex pt-5 flex-col items-start gap-3 self-stretch border-b border-[#D9D9D9] last:border-b-0">
                    ...
                    <div className="flex flex-col items-start gap-2.5 self-stretch">
                      {section.items.map((item, itemIndex) => (
                        <div key={itemIndex} className={`flex p-3 items-center gap-5 self-stretch rounded-md ${item.highlighted ? 'bg-[#E8F3FF]' : ''}`}>
